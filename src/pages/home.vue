  ...
  <div>
    ...
    <section class="narrow-wrapper my-24 lg:my-52">
      <BaseHeading size="h2" class="text-center">
        The world's <span class="text-green-500 underline">first</span> limited
        window requests management tool.
      </BaseHeading>
      ...
      <div class="max-w-3xl mx-auto">
        <div class="grid lg:grid-cols-2 gap-12 items-center my-20 lg:my-48">
          <div class="flex flex-col space-y-3">
            ...
            <BaseHeading class="text-blue-500" size="h3"
              >Schedule Request Windows</BaseHeading
            >
            <BaseText>
              Pre-define moments for your requests form to be live and actively
              accepting new inquiries.<br /><br />Customize the prospects form
              with as many, or as little, fields as you need!
            </BaseText>
          </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center my-20 lg:my-48">
          ...
          <div class="flex flex-col space-y-3">
            ...
            <BaseHeading class="text-blue-500" size="h3"
              >Search &amp; Tag your Backlog</BaseHeading
            >
            <BaseText>
              Review, search, & filter your backlog by keyword, general search,
              custom tags, or filtered down by booking windows.<br /><br />Finding
              the right prospects has never been easier!
            </BaseText>
          </div>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center my-20 lg:my-48">
          <div class="flex flex-col space-y-3">
            ...
            >
            <BaseText>
              Review and respond to prospects requests from the easy-to-use
              dashboard. Mark requests as denied, approved, contacted, and
              booked!<br /><br />
...
<script>
// import ScheduleGraphic from "./assets/Schedule.svg";
